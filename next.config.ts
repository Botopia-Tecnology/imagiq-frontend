        ...
        headers: [
          {
            ...
            value: [
              ...
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self' https://www.facebook.com https://*.facebook.com https://www.googletagmanager.com https://*.google.com https://*.tiktok.com https://*.epayco.co https://*.epayco.com https://3ds.epayco.com https://*.alignet.io https://*.cardinalcommerce.com https://*.secureacs.com https://*.3dsecure.io https://*.netcetera.com https://*.gpsrv.com",
