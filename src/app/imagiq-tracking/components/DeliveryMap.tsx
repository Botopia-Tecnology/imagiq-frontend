        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 flex items-start gap-2 min-w-0">
            <div className="w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              >
                <path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2" fill="#3B82F6"/>
                <path d="M15 18H9"/>
                <path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 0 17.52 8H14" fill="#3B82F6"/>
                <circle cx="17" cy="18" r="2" fill="#3B82F6"/>
                <circle cx="7" cy="18" r="2" fill="#3B82F6"/>
              </svg>
            </div>
          ...
          <div className="flex-1 flex items-start gap-2 min-w-0">
            <div className="w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
              <svg
                ...
                strokeLinejoin="round"
              >
                <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" fill="#EF4444"/>
              </svg>
            </div>
            <div className="min-w-0 flex-1">
              <span className="text-xs font-medium text-gray-900 block break-words">
