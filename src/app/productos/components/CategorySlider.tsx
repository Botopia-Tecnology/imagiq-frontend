...
export default function CategorySlider({
  ...
  React.useEffect(() => {
    ...
    style.innerHTML = `
      ...
      @media (max-width: 480px) and (orientation: landscape) {
        .category-slider-flex-gap {
          gap: 100rem !important; /* Ajusta aquí la separación horizontal */
        }
      }
    `;
  ...
  return (
    <section
      className={cn(
        ...
        "min-[1024px]:py-8",           // PC
        "max-[1023px]:py-0",           // móvil/tablet
        "max-[480px]:mt-[-50px]",      // móvil vertical
        "min-[481px]:max-[1023px]:mt-[-40px]", // tablet: margen superior similar a móvil
        className
      )}
    ...
    >
      <div
        className={cn(
          ...
          "max-[1023px]:container max-[1023px]:mx-auto max-[1023px]:px-0"
        )}
        style={{ overflow: "visible" }}
      >
        <div
        ...
        >
          ...
          <div className={cn(
            ...
            <div
              ref={sliderRef}
              className={cn(
                "flex transition-transform duration-300 ease-in-out justify-between items-end w-full category-slider-flex-gap",
                "min-[1024px]:gap-x-0",
                "max-[1023px]:gap-x-3",
                "max-[480px]:ml-3",
                "min-[481px]:max-[1023px]:ml-3"
              )}
              style={{
            ...
            >
              {categories.map((category, index) => (
                ...
                >
                  ...
                  {/* Texto debajo */}
                  <div className={cn(
                    "text-center mt-6",           // PC: margen superior normal
                    "max-[480px]:mb-6"            // móvil: margen inferior extra
                  )}>
