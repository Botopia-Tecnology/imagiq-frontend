  ...
  return (
    <div className="space-y-4 w-full">
      ...
      <section className="max-w-xl w-full">
        ...
        <div className="bg-gray-50 rounded-xl p-3 mb-3 border border-gray-200 hover:shadow-md transition-shadow duration-200">
          <div className="flex gap-3 items-start">
            <div className="flex-shrink-0 w-16 h-16 relative bg-white rounded-lg">
              <Image
            ...
            <div className="flex-1 min-w-0">
              ...
              <h4 className="font-bold text-sm text-[#222] mb-1 leading-tight">
                Selecciona Estreno y Entrego
              </h4>
              <p className="text-xs text-[#666] mb-1 leading-snug">
        ...
        <div className="bg-gray-50 rounded-xl p-3 border border-gray-200 hover:shadow-md transition-shadow duration-200">
          <div className="flex gap-3 items-start">
            <div className="flex-shrink-0 w-16 h-16 relative bg-white rounded-lg">
              <Image
      ...
      {/* Resumen de Compra */}
      <div className="bg-gray-50 rounded-2xl p-4 sm:p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 mb-32 max-w-xl w-full">
