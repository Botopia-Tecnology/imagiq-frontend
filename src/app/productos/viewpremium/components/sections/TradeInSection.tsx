        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-gray-100 p-3 rounded-lg shadow-sm border border-gray-100">
            <div className="flex items-center">
              <div className="w-20 h-20 flex-shrink-0 mr-4 rounded-lg bg-blue-50 flex items-center justify-center">
                <RefreshCcw className="w-10 h-10 text-blue-600" strokeWidth={2} />
              </div>
