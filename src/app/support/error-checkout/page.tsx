  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-red-50 p-6">
      <div className="max-w-xl w-full bg-white rounded-xl shadow p-8 text-center">
        <h1 className="text-2xl font-bold text-rose-700 mb-4">Pago de Soporte No Procesado</h1>
        <p className="text-sm text-gray-600 mb-6">Lo sentimos. Hubo un problema al procesar el pago de soporte.</p>
        ...
        <div className="flex justify-center gap-3">
          <a href="/soporte/inicio_de_soporte" className="px-4 py-2 bg-rose-600 text-white rounded">Volver a soporte</a>
