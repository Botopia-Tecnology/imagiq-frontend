  ...
  },
  {
    ...
    links: [
      { name: "Inicio de soporte", href: "/soporte/inicio_de_soporte" },
      {
        ...
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/20250701___20251231___TyC_0percent_Inters_Bancolombia_20250722_wrj6mw.pdf",
        external: true,
      },
      {
        name: "T&C 0% de interés Davivienda",
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/20251001_20251231_TyC_0percent_Interes_Banco_Davivienda_2025_10_08_ecehag.pdf",
        external: true,
      },
      {
        name: "Políticas generales",
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/POLITICAS_GENERALES_IMAGIQ_uqajce.pdf",
        external: true,
      },
      {
        name: "Políticas de uso de cookies",
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/POLÍTICA_USO_DE_COOKIES_nd34y7.pdf",
        external: true,
      },
      {
        name: "Tratamiento de datos personales",
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/PROTECCION_GENERAL_DE_TRATAMIENTO_DE_DATOS_PERSONALES_jzewbi.pdf",
        external: true,
      },
      {
        name: "Política anticorrupción y soborno",
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/tyc_Politica_Anticorrupcion_y_Soborno_SAMSUNG_25_04_2024_cml6u0.pdf",
        external: true,
      },
      {
        name: "Aviso legal",
        href: "https://res.cloudinary.com/dqsdl9bwv/image/upload/Home/AVISO_LEGAL_IMAGIQ_aczerz.pdf",
        external: true,
      },
    ],
  },
