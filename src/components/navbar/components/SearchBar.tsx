...
export const SearchBar: FC<Props> = ({ value, onChange, onSubmit }) => (
  <form
    onSubmit={onSubmit}
    className="relative flex items-center rounded-full px-5 h-12 lg:px-4 lg:h-10 transition-all duration-300 w-[220px] lg:w-[190px] xl:w-[220px] 2xl:w-[260px] backdrop-blur-md border border-gray-200 bg-white shadow-md"
    style={{
      overflow: "hidden",
