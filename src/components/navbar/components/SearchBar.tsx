...
export const SearchBar: FC<Props> = ({ value, onChange, onSubmit }) => (
  <form
    onSubmit={onSubmit}
    className="relative flex items-center rounded-full px-5 h-12 lg:px-4 lg:h-10 transition-all duration-300 w-[240px] lg:w-[200px] xl:w-[240px] 2xl:w-[280px] backdrop-blur-md border border-gray-200 bg-white shadow-md"
    style={{
      overflow: "hidden",
