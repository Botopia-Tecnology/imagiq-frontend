    ...
    <div className="relative h-[450px] flex items-center justify-center mx-24 md:mx-32 lg:mx-40 xl:mx-48">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
          Conecta con nuestro equipo de soporte a través de WhatsApp y recibe ayuda instantánea
        </p>
        ...
        <div className="flex justify-center">
          <button className="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-full font-bold text-lg transition-colors duration-200 shadow-lg hover:shadow-xl">
            Iniciar Chat
          </button>
        </div>
      </div>
