...
export const createMockOrderItems = (): OrderItem[] => [
  {
    ...
    product: {
      ...
      images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=80&h=80&fit=crop'] as any,
  ...
  },
  {
    ...
    product: {
      id: 'prod-2',
      name: 'Jeans Slim Fit',
      images: ['https://images.unsplash.com/photo-1542272454315-7ad66931c68b?w=80&h=80&fit=crop'] as any,
      slug: 'jeans-slim-fit',
      categoria: 'ropa',
...
export const createMockError = (message: string = 'Something went wrong'): Error =>
  new Error(message);
